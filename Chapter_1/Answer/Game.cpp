...
Game::Game()
{
	...
	m_star[1]->m_position.x = 200.0f;
	m_star[1]->m_position.y = 0.0f;

	m_star[2]->m_position.x = 100.0f;
	m_star[2]->m_position.y = 0.0f;

	m_star[3]->m_position.x = 400.0f;
	m_star[3]->m_position.y = 200.0f;

	m_star[4]->m_position.x = 400.0f;
	m_star[4]->m_position.y = 300.0f;

	m_mikyan->m_position.x = 500.0f;
	m_mikyan->m_position.y = 200.0f;
}
//デストラクタ。
Game::~Game()
{
